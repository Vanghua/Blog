...
> **修改同步性：**
>
> > 非严格模式下，且不存在“解构，初始值，剩余参数”时，arguments和形参的修改是同步的。
> >
> > 严格模式下，获存在“解构，初始值，剩余参数”时，arguments无法和它们的修改同步。
...
>
> **<font color=red>注：只是RFC规范，硬给URL添加中文也可以，只是不符合标准，不能保证所有环境下都能被正确解析。</font>**
